    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'trainstaff'), (2, 'security'), (3, 'admin')], default=3)),
        ...
        migrations.CreateModel(
            name='train',
            fields=[
                ('train_no', models.IntegerField(default=1007, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('train_no', models.ForeignKey(default=1007, on_delete=django.db.models.deletion.CASCADE, to='trains.train')),
            ],
        ),
        migrations.CreateModel(
            name='Security',
